...
# Sleep here to allow hyprspace to fully update fullscreen state
sleep 0.05

# Run the hyprspace command to get fullscreen status of all windows
fullscreen_status=$(hyprspace list-windows --all --format '%{window-is-fullscreen}')
